...
describe('ResetPasswordService', function () {
    beforeEach(function () {
        ...
        fakeUserTokenRepository = new FakeUserTokensRepository_1.default();
        fakeHashProvider = new FakeHashProvider_1.default();
        resetPassword = new ResetPasswordService_1.default(fakeUsersRepository, fakeUserTokenRepository, fakeHashProvider);
    });
    ...
    it('should not be able to reset de password with non-existing token', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should not be able to reset de password with non-existing user ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
            switch (_a.label) {
